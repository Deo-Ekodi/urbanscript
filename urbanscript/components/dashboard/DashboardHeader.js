...
//                   <p>Each image generated will deduct one credit from your total.</p>
//                   <button 
...
const DashboardHeader = () => {
  ...
  useEffect(() => {
    if (session?.user) {
      ...
      // Set up polling to fetch credits every 10 seconds (adjust as needed)
            ...
            {showInfo && (
              <>
                ...
                <div className="absolute top-full left-0 mt-2 bg-white rounded-lg p-4 shadow-lg text-black z-50">
                  <h3 className="font-semibold">Credits Info</h3>
                  <p>You have {credits} credits available for generating images.</p>
                  <p>1 Credit = 1 Image generated.</p>
                  <button 
                    className="mt-2 text-blue-500 hover:underline" 
                    onClick={() => setShowInfo(false)}
                  >
