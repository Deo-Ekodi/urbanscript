...
//           {/* Conditionally render components based on user's authentication status */}
//           {activeComponent === "UserInfo" && <UserInfo />}
          
//           {activeComponent === "Tool" && (
//             <>
//               {/* If user is logged in, show the Tool; otherwise, show a prompt */}
//               {user ? <Tool /> : (
//                 <div className="text-center mt-20">
//                   <p className="text-xl mb-4">You need to log in to use this tool.</p>
//                   <button
